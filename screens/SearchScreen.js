        ...
        <View style={styles.container}>
            ...
            <View style={styles.searchContainer}>
                ...
                <TextInput
                    ...
                    onChangeText={(value) => setSearch(value)} value={search}
                />
            ...
            <View style={styles.articlesContainer}>
                {articles.map((article, i) => (
                    ...
                    <Image key={i} source={{ uri: article.url_image }} style={styles.articleImage} />
                ))}
            </View>

            {/* Footer */}
            <View style={styles.footer}>
                <TouchableOpacity style={styles.goToDressingButton} onPress={() => navigation.navigate('DressingScreen')}>
